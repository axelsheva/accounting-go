...
func (uc *UserCreate) AddBalanceIDs(ids ...int) *UserCreate {
	uc.mutation.AddBalanceIDs(ids...)
	return uc
}

// AddBalances adds the "balances" edges to the Balance entity.
func (uc *UserCreate) AddBalances(b ...*Balance) *UserCreate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uc.AddBalanceIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.BalancesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
