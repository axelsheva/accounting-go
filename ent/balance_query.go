...
func (bq *BalanceQuery) QueryUser() *UserQuery {
...
func (bq *BalanceQuery) WithUser(opts ...func(*UserQuery)) *BalanceQuery {
	query := (&UserClient{config: bq.config}).Query()
...
func (bq *BalanceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Balance, error) {
	...
	if query := bq.withUser; query != nil {
		if err := bq.loadUser(ctx, query, nodes, nil,
			func(n *Balance, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (bq *BalanceQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Balance, init func(*Balance), assign func(*Balance, *User)) error {
...
func (bq *BalanceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := bq.ctx.Fields; len(fields) > 0 {
		...
		if bq.withUser != nil {
			_spec.Node.AddColumnOnce(balance.FieldUserID)
		}
	}
