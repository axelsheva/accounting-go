...
// was not loaded in eager-loading.
func (e UserEdges) BalancesOrErr() ([]*Balance, error) {
	if e.loadedTypes[1] {
...
// QueryBalances queries the "balances" edge of the User entity.
func (u *User) QueryBalances() *BalanceQuery {
	return NewUserClient(u.config).QueryBalances(u)
}
